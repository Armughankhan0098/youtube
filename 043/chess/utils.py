...
def find_r_Index(label, c):
    ...
    while True:
        if (
            c == "W"
            and globVar.r_w_pieces[i].label == label
            or c != "W"
            and globVar.r_b_pieces[i].label == label
        ):
            return i
        else:
            i += 1
...
def findKingIndex(c):
    ...
    while True:
        if (
            c == "W"
            and globVar.w_pieces[i].type == "king"
            or c != "W"
            and globVar.b_pieces[i].type == "king"
        ):
            return i
        else:
            i += 1
